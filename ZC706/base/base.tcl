...
if { $list_projs eq "" } {
   create_project ${overlay_name} ${overlay_name} -part xc7z045ffg900-2
...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net AXI_GPIO_0_GPIO_${design_name}_INTF_PORT_0_led_4bits [get_bd_intf_ports led_4bits] [get_bd_intf_pins AXI_GPIO_0/GPIO]
  connect_bd_intf_net -intf_net AXI_GPIO_1_GPIO_${design_name}_INTF_PORT_1_dip_switches_4bits [get_bd_intf_ports dip_switches_4bits] [get_bd_intf_pins AXI_GPIO_1/GPIO]
  connect_bd_intf_net -intf_net AXI_GPIO_2_GPIO_${design_name}_INTF_PORT_2_gpio_sws_3bits [get_bd_intf_ports gpio_sws_3bits] [get_bd_intf_pins AXI_GPIO_2/GPIO]
  ...
  connect_bd_intf_net -intf_net SMART_CON_0_M01_AXI_AXI_GPIO_1_S_AXI [get_bd_intf_pins AXI_GPIO_1/S_AXI] [get_bd_intf_pins SMART_CON_0/M01_AXI]
  connect_bd_intf_net -intf_net SMART_CON_0_M02_AXI_AXI_GPIO_2_S_AXI [get_bd_intf_pins AXI_GPIO_2/S_AXI] [get_bd_intf_pins SMART_CON_0/M02_AXI]
  ...
  connect_bd_net -net PROC_SYS_RESET_0_peripheral_aresetn_AXI_GPIO_0_s_axi_aresetn [get_bd_pins AXI_GPIO_0/s_axi_aresetn] [get_bd_pins AXI_GPIO_1/s_axi_aresetn] [get_bd_pins AXI_GPIO_2/s_axi_aresetn] [get_bd_pins PROC_SYS_RESET_0/peripheral_aresetn]
  connect_bd_net -net ZYNQPS_0_FCLK_CLK0_PROC_SYS_RESET_0_slowest_sync_clk [get_bd_pins AXI_GPIO_0/s_axi_aclk] [get_bd_pins AXI_GPIO_1/s_axi_aclk] [get_bd_pins AXI_GPIO_2/s_axi_aclk] [get_bd_pins PROC_SYS_RESET_0/slowest_sync_clk] [get_bd_pins SMART_CON_0/aclk] [get_bd_pins ZYNQPS_0/FCLK_CLK0] [get_bd_pins ZYNQPS_0/M_AXI_GP0_ACLK]
  ...
  assign_bd_address -offset 0x41210000 -range 0x00010000 -target_address_space [get_bd_addr_spaces ZYNQPS_0/Data] [get_bd_addr_segs AXI_GPIO_1/S_AXI/Reg] -force
  assign_bd_address -offset 0x41220000 -range 0x00010000 -target_address_space [get_bd_addr_spaces ZYNQPS_0/Data] [get_bd_addr_segs AXI_GPIO_2/S_AXI/Reg] -force
